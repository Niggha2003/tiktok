export const MessageIcon = ({ width = '32px', height = '32px', classnames }) => {
    return (
        <svg
...
export const InboxIcon = ({ width = '32px', height = '32px', classnames }) => {
    return (
        <svg
            className={classnames}
            width={width}
...
export const HomeIcon = ({ width = '32px', height = '32px', classnames }) => {
    return (
        <svg
            className={classnames}
            width={width}
...
export const FollowingIcon = ({ width = '32px', height = '32px', classnames }) => {
    return (
        <svg
            className={classnames}
            width={width}
...
export const ExploreIcon = ({ width = '32px', height = '32px', classnames }) => {
    return (
        <svg
            className={classnames}
            fill="rgba(22, 24, 35, 1)"
...
export const LiveIcon = ({ width = '32px', height = '32px', classnames }) => {
    return (
        <svg
            className={classnames}
            width={width}
